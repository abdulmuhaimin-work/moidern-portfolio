      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
            Hello! I'm Muhaimin, a full stack developer with a passion for building web applications that are both visually appealing and functionally sound.
          </p>
          <a href='#about'>
            <MagicButton title='Show My Work' icon={<FaLocationArrow />} position='right' handleClick={() => {}} otherClasses='top-20 left-20' />
          </a>
        </div>
      </div>
    </div>
